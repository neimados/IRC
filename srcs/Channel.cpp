...
bool Channel::getBotIsActivated() const {
    return this->_botIsActivated;
}

void Channel::activateBot() {
    this->_botIsActivated = 1;
    return;
}

void Channel::desactivateBot(){
    this->_botIsActivated = 0;
}
